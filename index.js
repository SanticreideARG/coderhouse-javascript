...
const productos = [
    ...
    { id: 3, nombre: "Phillips One Blade Afeitadora Recortadora", precio: 4996, categoria: "Belleza y Cuidado Personal", descripcion: "La afeitadora Philips One Blade Face & Body QP2620-20 está diseñada para cortar el pelo, no la piel. Exclusiva tecnología OneBlade. Afeita. Protector para la piel de montaje sencillo para las zonas sensibles." },
    ...
    { id: 15, nombre: "Nintendo Switch 32GB Standard", precio: 125537, categoria: "Electronica/Gaming", descripcion: "Switch es una de las consolas más versátiles del mercado gracias a su uso portátil. Nintendo desarrolló este modelo con el objetivo de tener todas las comodidades de la tecnología en un aparato portátil" },
    ...
    { id: 19, nombre: "Nintendo Switch Oled 64gb Standard", precio: 178199, categoria: "Electronica/Gaming", descripcion: "Switch es una de las consolas más versátiles del mercado gracias a su uso portátil. Nintendo desarrolló este modelo con el objetivo de tener todas las comodidades de la tecnología en un aparato portátil" },
    ...
    { id: 33, nombre: "Cinta de correr electrica World Fitness Dh695", precio: 449999, categoria: "Deportes", descripcion: "Con su motor eléctrico, tu World Fitness 525CLASSICDH ofrece equilibrio y constancia en el ritmo. Calentar, caminar y correr a la velocidad que te propongas es posible. ¡No dejes de alcanzar tus objetivos!" },
    { id: 34, nombre: "Bicicleta Venzo Loki Evo R29", precio: 116300, categoria: "Deportes", descripcion: "Cuadro aluminio termoformado de muy alta calidad y muy liviano, Horquilla con bloqueo, 21 velocidades Shimano, Frenos a discos mecanicos, Llantas doble pared rodado 29." },
    { id: 35, nombre: "Barra Body Pump + 2 Mancuernas + 24 kg Kit Set", precio: 17602, categoria: "Deportes", descripcion: "Barra cilíndrica de caño Metalico Cromado. La barra soporta entre 70 y 90 kilos, diseñada para todo tipo de actividad. Ideal para clases de Body Pump, Power, Power Fit, o Cross fitness." },
];
